...
function CountryCard ({ country }: Props) {
  return (
    <Link replace to={'country/' + country.cca2.toLowerCase()} className='grid min-h-[432px] justify-self-center overflow-hidden rounded-md bg-neutral-700 text-neutral-100'>
